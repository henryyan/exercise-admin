package com.runchain.exercise.admin.butil.member;
...
public class MemberUtil {
	...
	/**
	 * 生成延长会员卡的有效期
	 * @param oldPeriod		原有效期
	 * @param periodNum		延长值
	 * @param periodType	延长类型，{@link #MEMBER_CARD_TYPE_PERIOD_YEAR}，{@link #MEMBER_CARD_TYPE_PERIOD_MONTH}
	 * @return	延长的有效期
	 */
