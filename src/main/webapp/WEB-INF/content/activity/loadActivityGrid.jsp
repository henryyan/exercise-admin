...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
			...
			for (k in grid) {
				...
				for (a in activity) {
					...
					if(className != 'timeout') {
						if (orderId != 0) {
							appendContent.append("<td class='" + className + " order' orderId='" + orderId + "'>" + fieldName + "</td>");
						} else {
				...
				enter: function(tipObj) {
					...
					$.jsonp( {
						...
						success : function(order) {
			                ...
			                $('#dorderSite', '#tiptip_content').html(order.isOrderSite ? '是' : '否');
						},
						error : function(d, msg) {
							alert("error");
						}
	...
	<body>
		...
		<div id="orderInfo" class="template">
			...
			<div>网站预定：<span id="dorderSite"></span></div>
    	</div>
	</body>
</html>